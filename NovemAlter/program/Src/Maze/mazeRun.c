  ...
  while( motion_queue[motion_last] != 0 ){
    switch( motion_queue[motion_last] ){
      ...
      case CENRTER_SLAROM_LEFT:
        ...
        while( sen_l.now > sen_l.threshold && translation_ideal.distance < 15.0f );
        if ( translation_ideal.distance < 15.0 ) {
          translation_ideal.distance = 7.6f;
        }
        setStraight( 18.0f, translation->accel, 1900.0f, 1900.0f, 1900.0f );
        waitStraight();
        setRotation( 90.0f, 25000.0f, 1000.0f, 1900.0f );
        waitRotation();
        sidewall_control_flag = 1;
        setStraight( 38.0f, translation->accel, fast_path[motion_last].speed, 1900.0f, fast_path[motion_last].end_speed );
        waitStraight();
        break;
      ...
      case SLAROM_LEFT_180:
        ...
        while( sen_l.now > sen_l.threshold && translation_ideal.distance < 15.0f );
        if ( translation_ideal.distance < 15.0 ) {
          translation_ideal.distance = 5.4f;
        }
        setStraight( 30.0f, translation->accel, 1800.0f, 1800.0f, 1800.0f );
        waitStraight();
        setRotation( 180.0f, 30000.0f, 1180.0f, 1800.0f );
        waitRotation();
        sidewall_control_flag = 1;
        setStraight( 45.0f, translation->accel, fast_path[motion_last].speed, 1800.0f, fast_path[motion_last].end_speed );
        waitStraight();
        break;
      ...
      case DIA_CENTER_LEFT:
        ...
        waitRotation();
        dirwall_control_flag = 1;
        setStraight( 56.0f, translation->accel, fast_path[motion_last].speed, 1700.0f, fast_path[motion_last].end_speed );
        waitStraight();
        break;
      ...
      case DIA_CENTER_LEFT_135:
        ...
        waitRotation();
        dirwall_control_flag = 1;
        setStraight( 20.0f, translation->accel, fast_path[motion_last].speed, 1700.0f, fast_path[motion_last].end_speed );
        waitStraight();
        break;
      ...
      case DIA_LEFT_TURN:
        ...
        waitRotation();
        dirwall_control_flag = 1;
        setStraight( 21.0f, translation->accel, fast_path[motion_last].speed, 1600.0f, fast_path[motion_last].end_speed );
        waitStraight();
        break;
      ...
      case RETURN_DIA_LEFT:
        ...
        waitRotation();
        sidewall_control_flag = 1;
        setStraight( 22.0f, translation->accel, fast_path[motion_last].speed, 1700.0f, fast_path[motion_last].end_speed  );
        waitStraight();
        break;
      ...
      case RETURN_DIA_LEFT_135:
        ...
        waitRotation();
        sidewall_control_flag = 1;
        setStraight( 35.0f, translation->accel, fast_path[motion_last].speed, 1700.0f, fast_path[motion_last].end_speed  );
        waitStraight();
        break;
